            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				<div class="input-group">
							...
							<input id="phone" value="" onkeypress="return validnumberonly(event)"   type="tel" class="contactPhone form-control contactPhone">
							<span class="pull-right"> <a  class="pull-right" onClick="add_secondary_contact(1)"><i class="fa fa-plus-circle"></i></a></span> 
                ...
                <?php for($i=2;$i<=5;$i++) { ?>
				<div class="form-group telhideclass tdiv<?php echo $i; ?>">
				<label for="">Phone</label>
				<div class="input-group">
				<input type="tel" value=""   class="contactPhone form-control contactPhone" onkeypress="return validnumberonly(event)" id="phone<?php echo $i; ?>" name="contactPhone<?php echo $i; ?>" style="width:100%;" required/>
				<span class="pull-right">
				<a href="#" class="bplus<?php echo $i; ?>" id="btnAdd<?php echo $i; ?>" onClick="add_secondary_contact(<?php echo $i; ?>)"><i class="fa fa-plus-circle"></i></a>
				
				<a href="#" class="bminus<?php echo $i; ?>" id="btnRemove<?php echo $i; ?>" onClick="remove_secondary_contact(<?php echo $i; ?>)"><i class="fa fa-minus-square"></i></a>
				</span>
				...
				<div class="form-group ">
                    <label for="">Address</label>
						<div class="input-group">
						  ...
						  <div class="pick-area form_add">
							<input type="text" placeholder="Town" id="townsearchval" class="form-control" onkeyup="searchtown(this.value,event)">
						...
						<div class="input-group margin-top10">
							...
							<input type="text" name="street" id="street" value="" placeholder="Street" class="form-control">
						...
						<div class="input-group margin-top10">
							...
							<input type="text" id="refadr" name="refadr" value="" placeholder="Ref" class="form-control">
...
<!--start 2nd box-->
			...
			<div class="col-md-6">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
					  ...
					  <div class="clear"></div>  
						...
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<input id="datepicker" name="db" class="form-control" type="text" readonly />
                    ...
                    <label for="">Personal Discount</label>
						<div class="input-group">
							...
							<input type="text" id="pdiscount" onkeypress="return validdecimalnumberonly(event)" name="pdiscount" value=""  placeholder="Discount" class="form-control" maxlength="5"  onkeyup="onpdiscount(this.value)"/>
							<span class="input-group-addon">%</span>
						</div>
						<div id="pdiscount_err"  class="v-error" style="display:none;">
                        </div>
			  ...
			  <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <label for="">Payment Term</label>
						<div class="input-group">
							...
							<select  id="paymentMode" name="paymentMode" class="form-control" onchange="changepaymentterm();">
								  ...
								  <option value="cash commission">Cash commission</option>

								  <option value="cash referrer">Cash  referrer</option>
					...
					<div class="form-group cdiscount" style="display:none">
                    <label for="">Car Discount</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user-secret"></i></span>
							<span class="input-group-addon">-</span>
							<input type="text" id="cdiscount" onkeypress="return validdecimalnumberonly(event)" name="cdiscount" value="0"  placeholder="Car Discount" class="form-control" maxlength="5" >
							<span class="input-group-addon">%</span>
						</div>
					...
					<div class="form-group vdiscount" style="display:none">
                    <label for="">Van Discount</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user-secret"></i></span>
							<span class="input-group-addon">-</span>
							<input type="text" id="vdiscount" onkeypress="return validdecimalnumberonly(event)" name="vdiscount" value="0"  placeholder="Van Discount" class="form-control" maxlength="5">
							<span class="input-group-addon">%</span>
						</div>
                    ...
                    <label for="">Vat</label>
						<div class="input-group">
							...
							<input type="text"  name="vat" id="vat" value="" placeholder="Vat" class="form-control">
						</div>
	...
	<script>
		...
		if(c==1){
			var c=c+1;
			$(".tdiv"+c).removeClass('telhideclass');
			//$("#btnAdd").addClass('telhideclass');
			//$("#btnRemove").addClass('telhideclass');
			
		}else{
			
			if(c==4){
			$("#btnAdd"+c).addClass('telhideclass');
			$("#btnRemove"+c).addClass('telhideclass');
			var c=c+1;
			$(".tdiv"+c).removeClass('telhideclass');	
			$("#btnAdd"+c).addClass('telhideclass');
	...
	function remove_secondary_contact(c){
			...
			var c=c-1;
			$(".tdiv"+c).removeClass('telhideclass');
			$("#btnAdd"+c).removeClass('telhideclass');
			$("#btnRemove"+c).removeClass('telhideclass');
	...
	$(document).ready(function(){
		...
		$(".contactPhone").on("countrychange", function(e, countryData) {
		  ...
		  $("#MobileCode").val(countryData.iso2);
			...
			$(".contactPhone").intlTelInput({
			utilsScript: '<?php echo $this->webroot; ?>build/js/utils.js',
			autoPlaceholder: true
			});


            $(".contactPhone").intlTelInput("selectCountry", 'mt');
	...
	function saveform(){
		...
		*/
		...
		if(pdiscount!=""){
			...
			$("#pdiscount_err").show();
			$("#pdiscount_err").html("<p>Please enter personal discount.</p>");
			flag++;
		}
		...
		if(flag==0){
			 ...
			 jQuery.ajax({					 
						type: "POST",
						url: "<?php echo $this->webroot; ?>Clients/ajax_add",
						dataType: "text",
						timeout:1000000,
						data: {fname:fname,lname:lname,phone:phone,phone2:phone2,phone3:phone3,phone4:phone4,phone5:phone5,town:town,db:db,refadr:refadr,pdiscount:pdiscount,discount:discount,paymentMode:paymentMode,vat:vat,street:street,mobileCode:mobileCode,note:note,vdiscount:vdiscount,cdiscount:cdiscount},
