          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				<a href="javascript:void(0)" class="bplus<?php echo $i; ?>" id="btnAdd<?php echo $i; ?>" onClick="add_secondary_contact(<?php echo $i; ?>)"><i class="fa fa-plus-circle"></i></a>
				
				<a href="javascript:void(0)" class="bminus<?php echo $i; ?>" id="btnRemove<?php echo $i; ?>" onClick="remove_secondary_contact(<?php echo $i; ?>)"><i class="fa fa-minus-square"></i></a>
				</span>
                    ...
                    <div class="form-group">
					  ...
					  <div class="clear"></div>  
						...
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<input id="datepicker" name="<?php echo date('dd-mm-YY',strtotime($client['Client']['DOB'])); ?>" class="form-control" type="text" readonly />
