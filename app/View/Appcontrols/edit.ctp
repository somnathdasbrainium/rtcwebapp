				...
				<div class="form-group">
                    <label for="">Start Date</label>
						<div class="input-group">
							...
							<?php echo $this->Form->input('startdate',array( 'label'=>false,'type' => 'text','placeholder'=>'start date','readonly'=>'readonly','class'=>'form-control', 'id'=>'datepicker1'));?>
		   ...
		   <div class="form-group">
                    <label for=""> End Date </label>
						<div class="input-group">
							...
							<?php echo $this->Form->input('enddate',array( 'label'=>false,'type' => 'text','placeholder'=>'End date','readonly'=>'readonly', 'class'=>'form-control', 'id'=>'datepicker2'));?>
...
<input type="text" name="starttime" class="form-control" readonly="readonly" value="<?php echo date("H:i", strtotime($apps['Appcontrol']['starttime']));?>" placeholder="12:00" id="timecall"  maxlength="5" />

<!--time--><select class="hour"  style="width: auto;" id="hr" onchange="showhr(this.value)">
...
<!--time-->
		   ...
		   <div class="form-group">
				...
				<input type="text" name="endtime" readonly="readonly" class="form-control" value="<?php echo date("H:i", strtotime($apps['Appcontrol']['endtime']));?>" placeholder="12:00" id="timecall1"  maxlength="5"/>
...
if(datepicker1==''){
	...
	alert('Starttime should not be Greater than or equal to Endtime');
	$("#timecall").focus();
	$("#min1").focus();
